...
//        if ($participant->teacher_id == self::get_student_logged_in()->id) {
...
//        } else
//            Redirect::to('/', array('message' => 'Et voi poistaa toisen luoman kurssin osallistujia!'));
    }
